...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-White Rabbit/ActiveLabel.framework"
  install_framework "Pods-White Rabbit/BGTableViewRowActionWithImage.framework"
  install_framework "Pods-White Rabbit/BTNavigationDropdownMenu.framework"
  install_framework "Pods-White Rabbit/BWWalkthrough.framework"
  install_framework "Pods-White Rabbit/Bolts.framework"
  install_framework "Pods-White Rabbit/CLImageEditor.framework"
  install_framework "Pods-White Rabbit/ChameleonFramework.framework"
  install_framework "Pods-White Rabbit/ContentfulDeliveryAPI.framework"
  install_framework "Pods-White Rabbit/DACircularProgress.framework"
  install_framework "Pods-White Rabbit/DZNEmptyDataSet.framework"
  ...
  install_framework "Pods-White Rabbit/IDMPhotoBrowser.framework"
  install_framework "Pods-White Rabbit/IPDFCameraViewController.framework"
  ...
  install_framework "Pods-White Rabbit/PagingMenuController.framework"
  install_framework "Pods-White Rabbit/Parse.framework"
  install_framework "Pods-White Rabbit/ParseCrashReporting.framework"
  install_framework "Pods-White Rabbit/ParseFacebookUtilsV4.framework"
  install_framework "Pods-White Rabbit/ParseTwitterUtils.framework"
