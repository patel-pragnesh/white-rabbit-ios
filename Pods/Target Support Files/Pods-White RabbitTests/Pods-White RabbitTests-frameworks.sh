...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-White RabbitTests/BGTableViewRowActionWithImage.framework"
  install_framework "Pods-White RabbitTests/BTNavigationDropdownMenu.framework"
  install_framework "Pods-White RabbitTests/BWWalkthrough.framework"
  install_framework "Pods-White RabbitTests/Bolts.framework"
  install_framework "Pods-White RabbitTests/CLImageEditor.framework"
  install_framework "Pods-White RabbitTests/ChameleonFramework.framework"
  install_framework "Pods-White RabbitTests/ContentfulDeliveryAPI.framework"
  install_framework "Pods-White RabbitTests/DACircularProgress.framework"
  install_framework "Pods-White RabbitTests/DZNEmptyDataSet.framework"
  ...
  install_framework "Pods-White RabbitTests/IDMPhotoBrowser.framework"
  install_framework "Pods-White RabbitTests/IPDFCameraViewController.framework"
  ...
  install_framework "Pods-White RabbitTests/PagingMenuController.framework"
  install_framework "Pods-White RabbitTests/Parse.framework"
  install_framework "Pods-White RabbitTests/ParseCrashReporting.framework"
