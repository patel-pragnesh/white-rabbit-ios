...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-White RabbitUITests/BGTableViewRowActionWithImage.framework"
  install_framework "Pods-White RabbitUITests/BTNavigationDropdownMenu.framework"
  install_framework "Pods-White RabbitUITests/BWWalkthrough.framework"
  ...
  install_framework "Pods-White RabbitUITests/ChameleonFramework.framework"
  install_framework "Pods-White RabbitUITests/ContentfulDeliveryAPI.framework"
  install_framework "Pods-White RabbitUITests/DACircularProgress.framework"
  install_framework "Pods-White RabbitUITests/DZNEmptyDataSet.framework"
  ...
  install_framework "Pods-White RabbitUITests/IDMPhotoBrowser.framework"
